...
def train():
    ...
    model.load_state_dict(torch.load(r"../Trained_Models/molecolyte_qm9_pretrained_bigger_best.pt"))
    ...
    model.prediction_head = nn.Sequential(
        ...
        nn.ReLU(),
        nn.Dropout(0.3),
        nn.Linear(64, 12)  # 12 targets for Tox21
    )
    ...
    for epoch in range(EPOCHS):
        ...
        if avg_val_loss < best_loss:
            ...
            torch.save(model.state_dict(), r"../Trained_Models/molecolyte_tox21_random_spilt_finetuned_bigger_best.pt")
